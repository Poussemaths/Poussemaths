// Fonction consolidee : valide les templates generatifs propres a 5e, routee
// par template_id (chantier de consolidation du 30/07/2026). Meme structure
// que exo-4eme-valider (parseReponse, fallback eleve absent du 29/07/2026
// preserve, tolerance/defaults par template via table DEFAULTS).

// Template : theoreme de Pythagore, calcul de l'hypotenuse. Triplets pythagoriciens
// multiplies par un facteur pour garantir un resultat entier exact.
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const token = await encryptPayload({ x: reponse, template: "pythagore_v1", ts: Date.now() });

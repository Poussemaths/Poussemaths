// Template : terme d'une suite arithmetique, saisie libre (nombre entier).
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const token = await encryptPayload({ x: reponse, template: "suite_arithmetique_v1", ts: Date.now() });

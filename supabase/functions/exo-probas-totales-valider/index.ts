// Valide la reponse d'un eleve pour le template probas_totales_v1.
  ...
  try {
    ...
    if (eleveId) {
      ...
      const writeResp = await fetch(`${supabaseUrl}/rest/v1/progression?on_conflict=eleve_id,exercice_id`, {
        ...
        body: JSON.stringify({
          eleve_id: eleveId,
          exercice_id: exercice_id ?? "probas_totales_v1",
          chapitre: chapitre ?? "Probabilités conditionnelles et indépendance",
          niveau: niveau ?? "1ere",

// Fonction consolidee : valide les templates generatifs de 1ere, routee par
// template_id (chantier de consolidation du 30/07/2026). Meme structure que
// les autres niveaux (parseReponse, fallback eleve absent du 29/07/2026,
// tolerance/defaults par template).
...
const DEFAULTS: Record<string, { tolerance: number; chapitre: string; niveau: string }> = {
  suite_premiers_termes_v1: { tolerance: 0.001, chapitre: "Suites — définition et premiers termes", niveau: "1ere" },
  suite_arithmetique_v1: { tolerance: 0.001, chapitre: "Suites arithmétiques", niveau: "1ere" },
  suite_geometrique_v1: { tolerance: 0.001, chapitre: "Suites géométriques", niveau: "1ere" },

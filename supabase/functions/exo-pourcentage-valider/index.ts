// Valide la reponse d'un eleve pour le template pourcentage_v1.
// Meme logique que exo-equation-valider : reponse jamais transmise en clair,
// score calcule et ecrit cote serveur uniquement.
  ...
  try {
    ...
    const writeResp = await fetch(
      `${supabaseUrl}/rest/v1/progression?on_conflict=eleve_id,exercice_id`,
      {
        ...
        body: JSON.stringify({
          eleve_id: eleveId,
          exercice_id: exercice_id ?? "pourcentage_v1",
          chapitre: chapitre ?? "pourcentages",
          niveau: niveau ?? "5eme",
          score,

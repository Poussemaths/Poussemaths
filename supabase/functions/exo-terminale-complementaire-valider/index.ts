// Fonction consolidee : valide les templates generatifs propres a Terminale
// Complementaire, routee par template_id. Meme structure que les autres
// exo-<niveau>-valider.
...
const DEFAULTS: Record<string, { tolerance: number; chapitre: string; niveau: string }> = {
  loi_uniforme_v1: { tolerance: 0.006, chapitre: "Lois à densité", niveau: "terminale_complementaire" },
  loi_exponentielle_v1: { tolerance: 0.006, chapitre: "Lois à densité", niveau: "terminale_complementaire" },
  esperance_densite_v1: { tolerance: 0.006, chapitre: "Lois à densité", niveau: "terminale_complementaire" },

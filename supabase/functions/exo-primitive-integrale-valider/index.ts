// Valide la reponse d'un eleve pour le template primitive_integrale_v1.
  ...
  try {
    ...
    if (eleveId) {
      ...
      const writeResp = await fetch(`${supabaseUrl}/rest/v1/progression?on_conflict=eleve_id,exercice_id`, {
        ...
        body: JSON.stringify({
          eleve_id: eleveId,
          exercice_id: exercice_id ?? "primitive_integrale_v1",
          chapitre: chapitre ?? "Primitives et calcul intégral",
